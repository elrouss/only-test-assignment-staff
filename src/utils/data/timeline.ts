    ...
    data: [
      ...
      },
      {
        ...
        dates: {
          ...
          1997: `Дарио Фо получает Нобелевскую премию по литературе с формулировкой ${GUILLEMET_LEFT}За то, что он, подражая средневековым шутам, порицает власть и авторитет и защищает достоинство угнетенных${GUILLEMET_RIGHT}`,
        },
      },
      {
        heading: 'Театр',
        dates: {
          ...
          2000: `Возобновлено издание журнала${GUILLEMET_LEFT}Театр${GUILLEMET_RIGHT} ${N_DASH}`,
      ...
      },
      {
        ...
        dates: {
          ...
          2022: `Учёные с помощью телескопа ${GUILLEMET_LEFT}Хаббл${GUILLEMET_RIGHT} впервые обнаружили чёрную дыру, которая создаёт звёзды, а не поглощает их`,
        },
      },
    ],
  },
